...
const EditEvent = () => {
  ...
  const onSubmit = async (data, status = null) => {
    try {
      // If status is not provided, keep the current event status
      ...
      if (result.success) {
        ...
        setSuccessMessage(
          eventStatus === "draft"
            ? "Event saved as draft! You can edit and publish it later."
      ...
      <div className="w-11/12 mx-auto container py-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600 mt-2">
            Update your event information below. Save as draft or publish when ready.
          </p>
        </div>
