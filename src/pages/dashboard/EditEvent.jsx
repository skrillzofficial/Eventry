...
const EditEvent = () => {
  ...
  const [existingImages, setExistingImages] = useState([
    { url: "https://images.unsplash.com/photo-1540575467063-178a50c2df87?w=800", id: "existing-1" },
  ]);
  ...
  const [ticketTypes, setTicketTypes] = useState([
    {
      ...
      benefits: ["Access to main hall", "Event materials"],
      accessType: "both",
  ...
  // Dynamic fields
  const [tags, setTags] = useState(["Technology", "Networking"]);
  const [tagInput, setTagInput] = useState("");
  const [requirements, setRequirements] = useState(["Valid ID required"]);
  ...
  const {
    ...
    defaultValues: {
      ...
      description: "Join us for an exciting day of innovation, networking, and learning from industry leaders in technology and entrepreneurship.",
      longDescription: "A comprehensive tech event featuring keynote speakers, panel discussions, and networking opportunities.",
      category: "Technology",
                        ...
                        {ticket.benefits && ticket.benefits.length > 0 && (
                          <div className="mt-4">
                            ...
                            <div className="space-y-2">
                              {ticket.benefits.map((benefit, bIndex) => (
                                <div
                                  key={bIndex}
                                ...
                                >
                                  ...
                                  <button
                                    type="button"
                                    onClick={() =>
                                      removeTicketBenefit(index, bIndex)
                                    }
                                    className="text-red-500 hover:text-red-700"
                                  >
                                    <X className="h-4 w-4" />
          ...
          {currentStep === 6 && (
            <div className="space-y-8">
                ...
                <div className="space-y-4">
                  ...
                  {existingImages.length + uploadedImages.length < 3 && (
                    <div>
                      ...
                      />
                      <p className="text-xs text-gray-500 mt-1">
                        Recommended: 1200x600 pixels, JPEG or PNG format. Max
                        5MB per image.
                      </p>
                      {imageUploading && (
              ...
              <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-6">
                ...
                <p className="text-sm text-gray-600 mb-4">
                  Add social media groups or communities related to this event
                </p>
                <button
                  type="button"
