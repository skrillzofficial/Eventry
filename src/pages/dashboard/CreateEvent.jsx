...
const CreateEvent = () => {
  ...
  const onSubmit = async (data) => {
    try {
      ...
      localStorage.setItem('organizerEvents', JSON.stringify([...existingEvents, eventData]));
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="text-center">
            ...
            <div className="space-x-4">
              <Link
                to="/login"
                className="bg-[#006F6A] text-white px-6 py-3 rounded-lg font-semibold hover:bg-[#005a55] transition-colors inline-flex items-center"
              >
                Sign In
              </Link>
              <Link
                to="/signup"
                className="border border-[#006F6A] text-[#006F6A] px-6 py-3 rounded-lg font-semibold hover:bg-[#006F6A] hover:text-white transition-colors inline-flex items-center"
              >
                Create Account
              </Link>
            </div>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="text-center">
            ...
            <p className="text-gray-500 mb-8">
              Current account type: <span className="font-semibold">Attendee</span>
            </p>
            <div className="space-x-4">
              <Link
                to="/dashboard"
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="bg-white rounded-2xl shadow-2xl p-8 text-center max-w-md mx-4">
          ...
          <h3 className="text-2xl font-bold text-gray-900 mb-2">Event Created Successfully!</h3>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          <Link
            ...
            className="inline-flex items-center text-[#006F6A] hover:text-[#005a55] mb-4"
          >
            <ArrowLeft className="h-4 w-4 mr-2" />
            Back to Dashboard
          </Link>
          <h1 className="text-3xl font-bold text-gray-300">Create New Event</h1>
          <p className="text-gray-400 mt-2">
            Fill in the details below to create your event.
          </p>
          <div className="mt-3 p-3 bg-blue-50 border border-blue-200 rounded-lg">
            <p className="text-sm text-blue-700">
              <strong>Note:</strong> Event creation is currently available in select Nigerian cities. More locations coming soon!
            </p>
          </div>
        </div>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                ...
                <input
                  type="text"
                  {...register('title')}
                  className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#006F6A] focus:border-transparent"
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div>
                ...
                {errors.ticketType && (
                  <p className="text-red-600 text-sm mt-1">{errors.ticketType.message}</p>
                )}
              </div>
            </div>
          </div>
            ...
            <div className="flex items-center space-x-6">
              <div className="flex-1">
                ...
                <input
                  ...
                  className="w-full text-sm text-gray-500 file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-[#006F6A] file:text-white hover:file:bg-[#005a55]"
                />
                <p className="text-xs text-gray-500 mt-1">
              ...
              {uploadedImage && (
                <div className="relative">
                  <img src={uploadedImage} alt="Event preview" className="h-20 w-20 object-cover rounded-lg" />
                  <button
                    type="button"
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            <div className="justify-between flex flex-col  items-center">
              <div className='flex flex-col text-center md:flex-col lg:flex-row md:items-center md:space-x-4 mb-4'>
                <h3 className="text-lg font-semibold text-gray-900">Ready to Create Your Event</h3>
                <p className="text-gray-600 text-sm">
                  Your event will be stored on the blockchain and visible to attendees.
                </p>
              </div>
              <div className="space-x-4 flex flex-col md:flex-row gap-2">
                <Link
                  to="/dashboard/organizer"
                  className="px-4 py-3 border text-center border-gray-300 text-gray-700 rounded-lg font-semibold hover:bg-gray-50 transition-colors"
                >
                  Cancel
                </Link>
                <button
                  ...
                  className="bg-[#006F6A] text-white px-6 py-3 rounded-lg font-semibold hover:bg-[#005a55] disabled:opacity-50 disabled:cursor-not-allowed transition-colors flex items-center"
                >
                  {isSubmitting ? (
                    <>
